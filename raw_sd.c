...
void app_main(void)
{
    ...
    audio_element_handle_t i2s_stream_reader, fatfs_stream_writer;
    ...
    const char *link_tag_main[2] = {"i2s", "fat"};
    ...
    audio_element_set_uri(fatfs_stream_writer, "/sdcard/rec.i2s");
